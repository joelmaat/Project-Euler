...
func LargestProduct(grid []uint64, dimension uint64, consecutive uint64) uint64 {
	var largest uint64 = 0
	return dimension + largest
}

func main() {
	grid := []uint64{8, 2, 22, 97, 38, 15, 0, 40, 0, 75, 4, 5, 7, 78, 52, 12, 50, 77, 91, 8,
